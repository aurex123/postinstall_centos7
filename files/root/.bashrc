...
export PS1='\n\[$bold\]\[$black\][\[$dk_blue\]\@\[$black\]]-[\[$red\]\u\[$yellow\]@\[$red\]\h\[$black\]]-[\[$pink\]\w\[$black\]]\[$reset\]\n\[$reset\]\$ '
...
alias clearme='clearme $(whoami)'

alias spot='spot -e proc -e run -e sys -e var/log -e var/lib/lxc -e var/lib/lxcfs'
alias sta='systemctl start'
alias sto='systemctl stop'
alias reinicia='systemctl restart'
alias journale='journalctl -xe'
alias journalef='journalctl -xef'
